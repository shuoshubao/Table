...
import { isAntdV3, componentName, getClassNames } from './config';
import {
    getStorageKey,
    defaultExtraConfig,
    mergeColumns,
...
class Index extends Component {
    ...
    static getDerivedStateFromProps(props, state) {
        if (!get(props, 'remoteConfig.fetch') && !isEqual(props.dataSource, state.dataSource)) {
            return {
    ...
    render() {
        ...
        return (
            <div
                className={classNames('dynamic-table', props.class, props.className, {
