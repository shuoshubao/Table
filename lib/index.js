...
import { cloneDeep, get, set, omit, isFunction, debounce, map, isEqual, isNull } from 'lodash';
...
class Index extends Component {
    ...
    renderHeader = () => {
        ...
        const { showTotal, storageKey } = { ...defaultExtraConfig, ...props.extraConfig };
        const hideHeader = isEveryFalsy(showTotal, prependHeader, appendHeader, storageKey);
        ...
        return (
            <div className={getClassNames('header')}>
                ...
                <div className={getClassNames('header-right')}>
                    ...
                    {!!storageKey && (
                        <ColumnsSetting
                            storageKey={getStorageKey(storageKey)}
                            columns={columns}
                            onChange={value => {
                                this.setState({
