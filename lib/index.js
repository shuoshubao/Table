...
import { cloneDeep, get, omit, isFunction, debounce, map, isNull, noop } from 'lodash';
...
class Index extends Component {
        ...
        this.setState(prevState => {
            return {
                dataSource: prevState.dataSource.filter(v => {
                    const uniqKey = isFunction(rowKey) ? rowKey(v) : v[rowKey];
                    return uniqKey !== key;
                })
            };
        });
    ...
    moveRow = (dragIndex, hoverIndex) => {
        ...
        this.setState({ dataSource: newDataSource });
        onDragSortEnd({ newDataSource, dataSource, dragIndex, hoverIndex });
    };
                    ...
                    <Table
                        ...
                        onRow={(record, index) => {
                            return {
                                ...
                                draggable: tableProps.draggable
                            };
                        }}
                        rowClassName={() => {
