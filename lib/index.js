...
class Index extends Component {
    ...
    componentDidMount() {
        const { showColumnsSetting, storageKey } = { ...defaultExtraConfig, ...this.props.extraConfig };
    ...
    renderHeader = () => {
        ...
        const { showTotal, showColumnsSetting } = { ...defaultExtraConfig, ...props.extraConfig };
        const hideHeader = isEveryFalsy(showTotal, prependHeader, appendHeader, showColumnsSetting);
        ...
        return (
            <div className={getClassNames('header')}>
                ...
                <div className={getClassNames('header-right')}>
                    ...
                    {showColumnsSetting && <ColumnsSetting onChange={() => {}} />}
                </div>
            </div>
        );
    };
