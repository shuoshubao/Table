    ...
    _createClass(Index, [
        {
            ...
            value: function onInputChange() {
                ...
                var isNeedReverse = isEveryTruthy(
                    !isEmptyValue(minValue),
                    !isEmptyValue(maxValue),
                    minValue > maxValue
                );
                                ...
                                switch ((_context.prev = _context.next)) {
                                    ...
                                    case 5:
                                        (fetchFunc = remoteConfig.fetch),
                                            ...
                                            (processFunc =
                                                _remoteConfig$process === void 0 ? noop : _remoteConfig$process);
                                        _context.next = 8;
                                    ...
                                    switch ((_context2.prev = _context2.next)) {
                                        ...
                                        case 7:
                                            (fetchFunc = remoteConfig.fetch),
                                                ...
                                                (processFunc =
                                                    _remoteConfig$process2 === void 0 ? noop : _remoteConfig$process2);
                                            _context2.next = 10;
                                            return fetchFunc();
    ...
    _createClass(Index, [
        {
            ...
            value: function render() {
                ...
                var componentProps = omit(this.props, [
                    'defaultValue',
                    'value',
                    'onChange',
                    'onCustomChange',
...
export {
    Index$2 as AutoComplete,
    Index$4 as Cascader,
    Index$6 as Checkbox,
    Index$9 as Input,
    Index$8 as RangeNumber,
    Index$7 as Select,
    Index as Slider,
    Index$1 as Switch,
    Index$5 as Tabs,
    Index$3 as TreeSelect
};
