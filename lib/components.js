...
import { version, Input, Select, InputNumber, Divider, Checkbox, Tabs, Cascader, TreeSelect, AutoComplete, Switch, Slider } from 'antd';
import { inRange, kebabCase, isFunction, omit, isEqual, map, cloneDeep, debounce, pick, noop, isObject, isNumber, last } from 'lodash';
  ...
  _createClass(Index, [{
    ...
    value: function () {
      var _componentDidMount = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var props, value, remoteConfig, showSearch, isMultipleAllSelect, _options, indeterminate, fetchFunc, _remoteConfig$process2, processFunc, responseData, options, _indeterminate;
