...
import { inRange, kebabCase, isFunction, omit, cloneDeep, pick, noop, isObject, map, isNumber, last, debounce } from 'lodash';
import { classNames, setAsyncState, isEveryTruthy, isEmptyValue, convertDataToEnum, convertDataToCascader } from '@nbfe/tools';
...
var Index$6 = /*#__PURE__*/function (_Component) {
  ...
  function Index(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onCheckAllChange", function (e) {
      var options = cloneDeep(_this.props.options);
    ...
    var value = cloneDeep(props.value);

    var _options = cloneDeep(props.options);

    _this.state = {
      checkedList: value,
      indeterminate: value.length && _options.length !== value.length,
      checkAll: _options.length === value.length
    };
    return _this;
  }
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var componentProps = omit(props, ['defaultValue', 'value', 'onChange', 'onCustomChange', 'indeterminate']);
      return /*#__PURE__*/React.createElement(Fragment, null, !!props.indeterminate && /*#__PURE__*/React.createElement(Checkbox, {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                responseData = _context.sent;
                options = convertDataToCascader(processFunc(responseData) || responseData, remoteConfig);
                this.setState({
                  options: options
                });
