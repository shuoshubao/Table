...
var InternalForm = function InternalForm(props, ref) {
    ...
    var formClassName = classNames(
        ...
        _defineProperty(_classNames, ''.concat(prefixCls, '-hide-required-mark'), mergedRequiredMark === false),
    ...
    return /*#__PURE__*/ React.createElement(
        ...
        function (_ref2) {
            ...
            var labelClassName = classNames(
                ((_classNames = {}),
                _defineProperty(_classNames, ''.concat(prefixCls, '-item-required'), required),
                _defineProperty(
                    _classNames,
                        ...
                        return /*#__PURE__*/ React.createElement(
                            'div',
                            {
                                ...
                                className: classNames(
                                    itemClassName,
                                    _defineProperty({}, ''.concat(baseClassName, '-').concat(errorStatus), errorStatus)
                                ),
                                style: itemStyle
                            },
                            error
...
var FormItemInput = function FormItemInput(props) {
    ...
    var errorListDom = /*#__PURE__*/ React.createElement(
...
function FormItem(props) {
    ...
    function renderLayout(baseChildren, fieldId, isRequired) {
        ...
        var itemClassName =
            ((_itemClassName = {}),
            _defineProperty(_itemClassName, ''.concat(prefixCls, '-item'), true),
            _defineProperty(
                _itemClassName,
                ''.concat(prefixCls, '-item-with-help'),
                help || debounceErrors.length || debounceWarnings.length
            ),
            ...
            _defineProperty(_itemClassName, ''.concat(prefixCls, '-item-has-error'), mergedValidateStatus === 'error'),
            _defineProperty(
                _itemClassName,
                ''.concat(prefixCls, '-item-is-validating'),
                mergedValidateStatus === 'validating'
            ),
            _defineProperty(_itemClassName, ''.concat(prefixCls, '-item-hidden'), hidden),
        ...
        function (control, renderMeta, context) {
            ...
            if (Array.isArray(children) && hasName) {
                ...
                var triggers = new Set(
                    [].concat(_toConsumableArray(toArray(trigger)), _toConsumableArray(toArray(mergedValidateTrigger)))
                );
                triggers.forEach(function (eventName) {
                    childProps[eventName] = function () {
                        ...
                        (_mergedControl$eventN = mergedControl[eventName]) === null || _mergedControl$eventN === void 0
                            ? void 0
                            : _mergedControl$eventN.call.apply(_mergedControl$eventN, [mergedControl].concat(args));
                        (_children$props$event = (_children$props = children.props)[eventName]) === null ||
                        _children$props$event === void 0
                            ? void 0
                            : _children$props$event.call.apply(_children$props$event, [_children$props].concat(args));
                    };
                });
